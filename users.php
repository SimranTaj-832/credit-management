...
<body>
    ...
    <div class="container">
        ...
        <h3 class="text-center">CREDIT TRANSFER</h3>
            <form class="form-inline" method="post">
            <div class="form-group"><input class="form-control" type="text" name="from_id" placeholder="Enter from_id"></div>
            <div class="form-group"><input class="form-control" type="text" name="to_id" placeholder="Enter to_id"></div>
            <div class="form-group"><input class="form-control" type="text" name="credit" placeholder="Enter amount"></div>
            <div class="form-group"><button class="btn btn-primary btn-submit" type="submit" name= "search"><i class="fa fa-cart-arrow-down"></i>&nbsp;TRANSFER</button>
            </div>
            </form>
            ...
            <tbody>
                        ...
                        $results;
                        $count;
                        $query="INSERT INTO `credit`(`from_id`, `to_id`, `credited amount`) VALUES ('$id1','$id2','$id3') UPDATE `userinfo` SET `currentcredit`=$id1.currentcredit-$id3 WHERE id='$id1'";
